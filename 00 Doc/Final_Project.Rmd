...
#**Graph 4**
This bargraph joins data from 2 of our datasets, USA_All_Healthcare.csv and healthcare.csv to show the percentage of females insured per state versus the percentage of males insured per state. More specifically, rather than showing the actual percentage of each gender, the visual shows a state's female and male insured percentage, and compares it to the national average of each gender's insured percentage.
